...
export function AccordionHeader({
    ...
    return (
        <motion.div
            data-active={isActive || undefined}
            className={cn(
                "p-4 cursor-pointer w-full transition-all font-semibold  text-neutral-500   data-active:bg-secondary  hover:bg-secondary hover:text-black flex justify-between gap-2 items-center",
                className,
            )}
            onClick={handleClick}
        >
        ...
        <AnimatePresence initial={true}>
            {isActive && (
                <motion.div
                    ...
                    className={cn(
                        " bg-secondary/50 px-2 data-active:bg-secondary text-background ",
                        className,
                    )}
                >
                    <motion.article
