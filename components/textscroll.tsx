...
const ScrollText = () => {
    ...
    const text = "Artistic visions from the mind of a genius";
    ...
    return (
        <ReactLenis root>
            <main className="w-full flex-row items-center justify-center bg-background ">

                <div
                    ref={targetRef}
                    className="relative box-border font-neuve text-foreground flex h-[215vh] items-center justify-center gap-[1vw] overflow-hidden bg-background p-[1vw]"
                >
                    <div
                        className="font-ndot w-full max-w-4xl text-center text-4xl uppercase tracking-tighter text-foreground"
                        style={{
                            perspective: "500px",
                        }}
                    >
...
export { CharacterV1, CharacterV2, CharacterV3, ScrollText };
